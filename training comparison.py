  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/xvm1965/esercizi/blob/main/training%20comparison.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "num_training_steps = num_epochs * len(train_dataloader) # calcola il numero di steps\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "o000ayuRIsrX",
        "outputId": "4726e809-9987-4c36-e53f-a7a948b584e7",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 1000,
          "referenced_widgets": [
            "cd316542bcd04cafbb0e23b4f381c53e",
            "4bdb3b2a912046dfa994367897a4e86c",
            "a2e09bbe923a4c208df590f71d04493d",
            "cec6cf2b099a499d99a13c5d737dbd18",
            "2d32ec936f86465c837a3b7de5466ae3",
            "5341fec7a204440e803c643572de1932",
            "478769baa3f5455f8e4ecd06d560a593",
            "dff143b3be1d4df8b228ba1f58b82214",
            "224149cb8461449486046d2a1e0cb225",
            "27a220d2d526498a93758f3abf357875",
            "124066db7fd1402ea8354a454aaa6a0e"
          ]
        }
      },
      "execution_count": null,
      "outputs": [
        ...
        },
        {
          ...
          "text": [
            "\n",
            "\n",
            " tempo richiesto per la tokenizzazione totale : 0.03193\n",
            " tempo richiesto per il setup dei dataloder del sistema con tokenizzazione al volo: 0.00068\n",
            " tempo richiesto per la normalizzazione di tokenized_datasets: 0.01200\n",
            " tempo richiesto per il setup dei dataloder del sistema con pre tokenizzazione: 0.00026\n",
            "type(pre_tokenize_train_dataloader): <class 'torch.utils.data.dataloader.DataLoader'>\n"
          ]
        },
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "data": {
            ...
            "application/vnd.jupyter.widget-view+json": {
              "version_major": 2,
              "version_minor": 0,
              "model_id": "cd316542bcd04cafbb0e23b4f381c53e"
            }
          },
          "metadata": {}
        },
        {
          ...
          "text": [
            ...
            "\n",
            "Pre tokenization training ...\n",
            "[    1] loss: 0.85123 min:0.85123(    1) max:0.85123(    1)\n",
            "[    2] loss: 0.85933 min:0.85123(    1) max:0.85933(    2)\n",
            "[    3] loss: 0.74251 min:0.74251(    3) max:0.85933(    2)\n",
            "[    4] loss: 0.74120 min:0.74120(    4) max:0.85933(    2)\n",
            "[    5] loss: 0.93613 min:0.74120(    4) max:0.93613(    5)\n",
            "[    6] loss: 0.78407 min:0.74120(    4) max:0.93613(    5)\n",
            "[    7] loss: 0.93553 min:0.74120(    4) max:0.93613(    5)\n",
            "[    8] loss: 0.92300 min:0.74120(    4) max:0.93613(    5)\n",
            "[    9] loss: 0.84575 min:0.74120(    4) max:0.93613(    5)\n",
            "[   10] loss: 0.90596 min:0.74120(    4) max:0.93613(    5)\n",
            "[   11] loss: 0.80237 min:0.74120(    4) max:0.93613(    5)\n",
            "[   12] loss: 0.78789 min:0.74120(    4) max:0.93613(    5)\n",
            "[   13] loss: 0.70098 min:0.70098(   13) max:0.93613(    5)\n",
            "[   14] loss: 0.65264 min:0.65264(   14) max:0.93613(    5)\n",
            "[   15] loss: 0.72488 min:0.65264(   14) max:0.93613(    5)\n",
            "[   16] loss: 0.61653 min:0.61653(   16) max:0.93613(    5)\n",
            "[   17] loss: 0.67208 min:0.61653(   16) max:0.93613(    5)\n",
            "[   18] loss: 0.76688 min:0.61653(   16) max:0.93613(    5)\n",
            "[   19] loss: 0.79200 min:0.61653(   16) max:0.93613(    5)\n",
            "[   20] loss: 0.78583 min:0.61653(   16) max:0.93613(    5)\n",
            "[   21] loss: 0.65025 min:0.61653(   16) max:0.93613(    5)\n",
            "[   22] loss: 0.75996 min:0.61653(   16) max:0.93613(    5)\n",
            "[   23] loss: 0.69666 min:0.61653(   16) max:0.93613(    5)\n",
            "[   24] loss: 0.70768 min:0.61653(   16) max:0.93613(    5)\n",
            "[   25] loss: 0.69801 min:0.61653(   16) max:0.93613(    5)\n",
            "[   26] loss: 0.63183 min:0.61653(   16) max:0.93613(    5)\n",
            "[   27] loss: 0.70462 min:0.61653(   16) max:0.93613(    5)\n",
            "[   28] loss: 0.67235 min:0.61653(   16) max:0.93613(    5)\n",
            "[   29] loss: 0.73015 min:0.61653(   16) max:0.93613(    5)\n",
            "[   30] loss: 0.63347 min:0.61653(   16) max:0.93613(    5)\n",
            "[   31] loss: 0.65700 min:0.61653(   16) max:0.93613(    5)\n",
            "[   32] loss: 0.59652 min:0.59652(   32) max:0.93613(    5)\n",
            "[   33] loss: 0.62083 min:0.59652(   32) max:0.93613(    5)\n",
            "[   34] loss: 0.61294 min:0.59652(   32) max:0.93613(    5)\n",
            "[   35] loss: 0.67246 min:0.59652(   32) max:0.93613(    5)\n",
            "[   36] loss: 0.56933 min:0.56933(   36) max:0.93613(    5)\n",
            "[   37] loss: 0.58295 min:0.56933(   36) max:0.93613(    5)\n",
            "[   38] loss: 0.65993 min:0.56933(   36) max:0.93613(    5)\n",
            "[   39] loss: 0.70984 min:0.56933(   36) max:0.93613(    5)\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        "id": "aKG0FidlBNia",
        "outputId": "ff38ec4f-b677-4473-d84b-e7697e3870cf",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "application/vnd.jupyter.widget-state+json": {
        "cd316542bcd04cafbb0e23b4f381c53e": {
          ...
          "state": {
            ...
            "box_style": "",
            "children": [
              "IPY_MODEL_4bdb3b2a912046dfa994367897a4e86c",
              "IPY_MODEL_a2e09bbe923a4c208df590f71d04493d",
              "IPY_MODEL_cec6cf2b099a499d99a13c5d737dbd18"
            ],
            "layout": "IPY_MODEL_2d32ec936f86465c837a3b7de5466ae3"
          }
        },
        "4bdb3b2a912046dfa994367897a4e86c": {
          "model_module": "@jupyter-widgets/controls",
          ...
          "state": {
            ...
            "layout": "IPY_MODEL_5341fec7a204440e803c643572de1932",
            "placeholder": "​",
            "style": "IPY_MODEL_478769baa3f5455f8e4ecd06d560a593",
            "value": "  0%"
          }
        },
        "a2e09bbe923a4c208df590f71d04493d": {
          ...
          "state": {
            ...
            "description": "",
            "description_tooltip": null,
            "layout": "IPY_MODEL_dff143b3be1d4df8b228ba1f58b82214",
            "max": 1377,
            "min": 0,
            "orientation": "horizontal",
            "style": "IPY_MODEL_224149cb8461449486046d2a1e0cb225",
            "value": 0
          }
        },
        "cec6cf2b099a499d99a13c5d737dbd18": {
          ...
          "state": {
            ...
            "description": "",
            "description_tooltip": null,
            "layout": "IPY_MODEL_27a220d2d526498a93758f3abf357875",
            "placeholder": "​",
            "style": "IPY_MODEL_124066db7fd1402ea8354a454aaa6a0e",
